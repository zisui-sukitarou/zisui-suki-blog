...
func Status(v uint) predicate.Blog {
	return predicate.Blog(func(s *sql.Selector) {
...
func StatusEQ(v uint) predicate.Blog {
	return predicate.Blog(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStatus), v))
	})
}
...
func StatusNEQ(v uint) predicate.Blog {
	return predicate.Blog(func(s *sql.Selector) {
...
func StatusIn(vs ...uint) predicate.Blog {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusNotIn(vs ...uint) predicate.Blog {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusGT(v uint) predicate.Blog {
	return predicate.Blog(func(s *sql.Selector) {
...
func StatusGTE(v uint) predicate.Blog {
	return predicate.Blog(func(s *sql.Selector) {
...
func StatusLT(v uint) predicate.Blog {
	return predicate.Blog(func(s *sql.Selector) {
...
func StatusLTE(v uint) predicate.Blog {
	return predicate.Blog(func(s *sql.Selector) {
