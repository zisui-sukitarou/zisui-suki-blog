...
func (bu *BlogUpdate) SetStatus(u uint) *BlogUpdate {
...
func (bu *BlogUpdate) AddStatus(u int) *BlogUpdate {
...
// SetStatus sets the "status" field.
func (buo *BlogUpdateOne) SetStatus(u uint) *BlogUpdateOne {
...
// AddStatus adds u to the "status" field.
func (buo *BlogUpdateOne) AddStatus(u int) *BlogUpdateOne {
