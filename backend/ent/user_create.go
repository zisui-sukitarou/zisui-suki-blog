...
func (uc *UserCreate) AddFavorIDs(ids ...string) *UserCreate {
	uc.mutation.AddFavorIDs(ids...)
	return uc
}

// AddFavors adds the "favors" edges to the Blog entity.
func (uc *UserCreate) AddFavors(b ...*Blog) *UserCreate {
	ids := make([]string, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return uc.AddFavorIDs(ids...)
}

// AddBlogIDs adds the "blogs" edge to the Blog entity by IDs.
func (uc *UserCreate) AddBlogIDs(ids ...string) *UserCreate {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.FavorsIDs(); len(nodes) > 0 {
