...
// HasFavors applies the HasEdge predicate on the "favors" edge.
func HasFavors() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FavorsTable, BlogFieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, FavorsTable, FavorsPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasFavorsWith applies the HasEdge predicate on the "favors" edge with a given conditions (other predicates).
func HasFavorsWith(preds ...predicate.Blog) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FavorsInverseTable, BlogFieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, FavorsTable, FavorsPrimaryKey...),
		)
...
func HasBlogs() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, true, BlogsTable, BlogsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
