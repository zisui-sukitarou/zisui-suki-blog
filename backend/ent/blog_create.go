...
func (bc *BlogCreate) AddUserIDs(ids ...string) *BlogCreate {
	bc.mutation.AddUserIDs(ids...)
	return bc
}

// AddUsers adds the "users" edges to the User entity.
func (bc *BlogCreate) AddUsers(u ...*User) *BlogCreate {
...
func (bc *BlogCreate) SetWriterID(id string) *BlogCreate {
	bc.mutation.SetWriterID(id)
	return bc
}

// SetWriter sets the "writer" edge to the User entity.
func (bc *BlogCreate) SetWriter(u *User) *BlogCreate {
	return bc.SetWriterID(u.ID)
}
...
func (bc *BlogCreate) check() error {
	...
	if _, ok := bc.mutation.WriterID(); !ok {
		return &ValidationError{Name: "writer", err: errors.New(`ent: missing required edge "Blog.writer"`)}
	}
	return nil
}
...
func (bc *BlogCreate) createSpec() (*Blog, *sqlgraph.CreateSpec) {
	...
	if nodes := bc.mutation.WriterIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
